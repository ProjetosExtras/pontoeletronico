...
import { generateRelatorioAtrasosPDF } from "@/utils/generators";
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Selecione o funcionário e o período para gerar o relatório de atrasos.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium leading-none">Tipo de Escala (Forçar)</label>
            <Select value={shiftType} onValueChange={setShiftType}>
              ...
              <SelectContent>
                ...
                <SelectItem value="seg_qui_sab_7_16_sex_7_11">SEG-QUI+SAB 07:00-16:00 | SEX 07:00-11:00</SelectItem>
                <SelectItem value="seg_sex_07_16_sab_08_12">SEG-SEX 07:00-16:00 | SAB 08:00-12:00</SelectItem>
